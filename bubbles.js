(function () {
  const COLORS = [
    ['rgba(249,168,212,0.22)', 'rgba(249,168,212,0.06)'],
    ['rgba(196,181,253,0.22)', 'rgba(196,181,253,0.06)'],
    ['rgba(253,164,175,0.20)', 'rgba(253,164,175,0.05)'],
    ['rgba(253,186,116,0.18)', 'rgba(253,186,116,0.05)'],
    ['rgba(167,139,250,0.20)', 'rgba(167,139,250,0.05)'],
    ['rgba(255,255,255,0.25)', 'rgba(255,255,255,0.05)'],
    ['rgba(103,232,249,0.18)', 'rgba(103,232,249,0.04)'],
  ];
